...
class Xophz_Compass_Bomb_Bag extends Xophz_Compass_Plugin_Base {
	...
	public function __construct( ?string $param1 = null, ?string $version = null, string $param3 = '' ) {
		if ( null === $param1 ) {
			$file = dirname( __DIR__ ) . '/xophz-compass-bomb-bag.php';
			$ver  = defined( 'XOPHZ_COMPASS_BOMB_BAG_VERSION' ) ? XOPHZ_COMPASS_BOMB_BAG_VERSION : '1.0.0';
			parent::__construct( $file, $ver, 'xophz-compass-bomb-bag' );
		} else {
